...
const artistSchema = new mongoose.Schema({
  ...
  genre: [{
    type: String,
    enum: ['rock', 'pop', 'hiphop', 'jazz', 'hardcore melódico', 'eletronic', 'classical', 'reggae', 'sertanejo', 'funk', 'mpb', 'indie', 'metal', 'punk', 'blues', 'r&b', 'gospel', 'alternativo', 'dream pop', 'shoegaze', 'math rock'],
  }],
  country: {
    type: String,
    default: 'BR',
